    ...
    <div class="row align-items-center mb-8">
      ...
      <div class="col-12 col-md-auto mt-3 mt-md-0 d-flex align-items-center gap-2">
        <button *appPermiso="'editar'; recurso: 'proyectos'" (click)="abrirClientes()"
                class="btn btn-default inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg transition-colors shadow-sm bg-[var(--color-surface)] hover:bg-[var(--color-gray-100)] border">
        ...
        <button *appPermiso="'crear'; recurso: 'proyectos'" (click)="abrirNuevo()"
                class="btn btn-primary inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg transition-colors shadow-sm bg-[var(--color-teal-600)] hover:bg-[var(--color-teal-700)]">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
